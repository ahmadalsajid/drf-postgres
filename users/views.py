...
class StudentViewSet(viewsets.ViewSet):
    ...
    def destroy(self, request, pk=None):
        try:
            _student = Student.objects.get(pk=pk)
            _user = _student.user
            _student.delete()
            _user.delete()
            return Response(
...
class TeacherViewSet(viewsets.ViewSet):
    ...
    @extend_schema(
        responses=PolymorphicProxySerializer(
            component_name='TeacherViewSet.list.responses',
    ...
    @extend_schema(
        request=PolymorphicProxySerializer(
            component_name='TeacherViewSet.create.request',
            serializers=[TeacherCreateSerializer, ],
            resource_type_field_name='TeacherViewSet.create.request',
        ),
        responses=PolymorphicProxySerializer(
            component_name='TeacherViewSet.create.responses',
            serializers=[TeacherSerializer, ],
            resource_type_field_name=None,
        )
    )
    ...
    @extend_schema(
        responses=PolymorphicProxySerializer(
            component_name='TeacherViewSet.retrieve.responses',
            serializers=[TeacherSerializer, ],
            resource_type_field_name=None,
        )
    )
    ...
    @extend_schema(
        request=PolymorphicProxySerializer(
            component_name='TeacherViewSet.patch.request',
            serializers=[TeacherCreateSerializer, ],
            resource_type_field_name='TeacherViewSet.patch.request',
        ),
        responses=PolymorphicProxySerializer(
            component_name='TeacherViewSet.patch.responses',
            serializers=[TeacherSerializer, ],
            resource_type_field_name=None,
        )
    )
    ...
    def destroy(self, request, pk=None):
        try:
            ...
            _teacher = Teacher.objects.get(pk=pk)
            _user = _teacher.user
            _teacher.delete()
            _user.delete()
            return Response(
